...
print(fabricyards(35)) #1
print(fabricyards(36)) #1
print(fabricyards(37)) #2	
print(fabricyards(0)) #0
print(fabricyards(1)) #1
print(fabricyards(72)) #2
print(fabricyards(73)) #3